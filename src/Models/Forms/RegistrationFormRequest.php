    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if (isset($data['morph_type']) && isset($data['morph_id'])) {
                if ( config('wk-registration.onoff.site') && !empty(config('wk-core.class.site.site')) && $data['morph_type'] == config('wk-core.class.site.site') ) {
                ...
                } elseif ( config('wk-registration.onoff.group') && !empty(config('wk-core.class.group.group')) && $data['morph_type'] == config('wk-core.class.group.group') ) {
